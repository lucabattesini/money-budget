...
2. If the user mentions multiple different expenses in the same message (e.g. "30 no mercado e 20 na farmacia"), you must extract EACH expense as a separate item in the list.
3. You must choose the most appropriate category for each item from the EXACT following list:
...
4. If a specific item does not explicitly mention any monetary value, return null for its 'amount' field.
5. The amount must be an integer (e.g., 16).
